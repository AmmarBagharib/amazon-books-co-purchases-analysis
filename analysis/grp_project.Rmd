...
baseline_0302 <- read.csv(here("outputs/baseline_features_0302.csv"))
baseline_network_0302 <- read.csv(here("outputs/baseline_and_network_metrics_0302.csv"))

baseline_0505 <- read.csv(here("outputs/baseline_features_0505.csv"))
baseline_network_0505 <- read.csv(here("outputs/baseline_and_network_metrics_0505.csv"))

baseline_0601 <- read.csv(here("outputs/baseline_features_0601.csv"))
...
data_frame_names <- c("baseline_0302", "baseline_network_0302", "baseline_0505", "baseline_network_0505", "baseline_0601")
...
scaled_baseline_0302 <- scale_dataset(baseline_0302)
scaled_baseline_network_0302 <- scale_dataset(baseline_network_0302)

scaled_baseline_0505 <- scale_dataset(baseline_0505)
scaled_baseline_network_0505 <- scale_dataset(baseline_network_0505)
scaled_baseline_0601 <- scale_dataset(baseline_0601)
...
# 
# # append book 1 and 2 attributes
# baseline_df <- baseline_df %>%
#   
#   left_join(books_df %>%
#               select(id, first_genre, cleaned_genres, 
#                      num_main_genres, rating, reviews, salesrank) %>%
#               rename(V1_rating = rating, V1_reviews = reviews, 
#                      V1_salesrank = salesrank, V1_first_genre = first_genre,
#                      V1_genres = cleaned_genres, V1_num_main_genres = num_main_genres),
#             by  = c("V1" = "id")) %>%
#   
#   left_join(books_df %>%
#               select(id, first_genre, cleaned_genres, 
#                      num_main_genres, rating, reviews, salesrank) %>%
#               rename(V2_rating = rating, V2_reviews = reviews, 
#                      V2_salesrank = salesrank, V2_first_genre = first_genre, 
#                      V2_genres = cleaned_genres, V2_num_main_genres = num_main_genres),
#             by  = c("V2" = "id")) %>%
...
# index <- createDataPartition(baseline_df$connected, p = 0.7, list = FALSE)
# 
# train_data <- subset(baseline_df[index, ], select=-c(`from_name`,
#                                                      `to_name`,
#                                                      `num_common_genre`,
#                                                      `from_salesrank`,
#                                                      `from_rating`,
...
#                                                      ))
# 
# test_data <- subset(baseline_df[-index, ], select=-c(`from_name`,
#                                                      `to_name`,
#                                                      `num_common_genre`,
#                                                      `from_salesrank`,
#                                                      `from_rating`,
...
# train_data$is_connected <- as.factor(train_data$connected)
# test_data$is_connected <- as.factor(test_data$connected)
# 
# print(paste("Number of positive class in train data:", sum(train_data$connected == 1)))
# print(paste("Number of negative class in original data:", sum(train_data$connected == 0)))
# 
...
# test_data_positive <- cbind(scaled_x_test, is_connected = test_data_positive$is_connected, 
#                             V1 = test_data_positive$V1, V2 = test_data_positive$V2)
