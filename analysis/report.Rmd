...
"Literature & Fiction" emerged as the most prevalent genre. However, this dominance might stem from its comprehensive nature, encompassing a vast array of books that likely include the diverse genres found further down the list, such as Science Fiction & Fantasy, Children's books and Series. Thus, we lumped these categories together. Following closely, "Biographies & Memoirs" secured the second spot, which is reasonable given that people generally possess keen interest in the personal lives of well-known figures, driven by admiration and curiosity (Knox, 2023).

Intriguingly, "Books on Tape" claimed the third position, underscoring the surge in popularity of audiobooks. This trend aligns with the convenience offered by audiobooks (DeCuir, 2022), allowing individuals to absorb literary content effortlessly during commutes or routine tasks. The notable presence of "Books on Tape" highlights a broader shift in how readers engage with literature, embracing the accessibility and ease provided by audiobook formats.
