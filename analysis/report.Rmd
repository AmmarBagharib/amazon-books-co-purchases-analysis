...
We also noticed that "Books on Tape" is rather low on the list, which was a little surprising, given the surge in popularity of audiobooks over the recent years (DeCuir, 2022). Audiobooks are convenient mediums which allow users to absorb literary content effortlessly while on the move or while performing mundane chores. Given the hectic lifestyles of many readers today, we expected it to be higher up on the list since it allows readers to "read" on the move.
