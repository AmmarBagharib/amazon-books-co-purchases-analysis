...
7. Louvain Community membership  
```

We tried several community detection algorithms but ultimately decided to go with the Louvain method as it resulted in clusters with higher modularity scores (i.e., better-defined cummunity structure). These serve as the training dataset for our two models.
